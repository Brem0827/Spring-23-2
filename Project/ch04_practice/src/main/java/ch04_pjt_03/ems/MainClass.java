...
//                new GenericXmlApplicationContext(appCtxs);
		...
		System.out.print("|마지막 회원 정보 수정일:" + selectedstudent.getsLastUpdateDate() + "\t");
		System.out.println("END ----------------------------");

		// 학생 수정
		StudentModifyService modifyService = ctx.getBean("studentModifyService", StudentModifyService.class);
		modifyService.modify(new Student("hbs006", "bbs006", "01000000000", "guswnd284@naver.com", "1972-11-21", "2023-09-12"));
